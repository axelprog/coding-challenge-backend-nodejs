...
describe('User validators ', () => {
  ...
  describe('correct validation', () => {
    ...
    test('it should validate get list of users', () => {
      req.query = {
        limit: 10,
        page: 1
      };

      mockValidation(validationRules.userGetList, req, (data) => {
        expect(data).toEqual(undefined);
      });
    });
  });
  ...
  describe('incorrect validation', () => {
    ...
    test('it should not validate get list of users without query', () => {
      mockValidation(validationRules.userGetList, req, (data) => {
    ...
    test('it should not validate get list of users with string query params', () => {
      req.query = {
        limit: 'test',
        page: 'sdf'
      };
    ...
    test('it should not validate get list of users with negative query params', () => {
      req.query = {
        limit: -10,
        page: -1
      };
